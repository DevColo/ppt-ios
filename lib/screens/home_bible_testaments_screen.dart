...
class HomeBibleScreen extends StatefulWidget {
  const HomeBibleScreen({super.key});

  @override
  State<HomeBibleScreen> createState() => _HomeBibleScreenState();
}

class _HomeBibleScreenState extends State<HomeBibleScreen> {
  bool isLoading = true;
